<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Naturel.aspx.cs" Inherits="ParaShop.WebForm9" %>
            ...
            <td style="border-color: inherit; border-width: thin; border-style: solid;" class="w-25">
                ...
                <table class="w-100">
                    ...
                    <tr>
                        <td>Quantité</td>
                        <td>
                            <asp:TextBox  ID="TextBox2" TextMode="Number" runat="server" min="0" max="20" step="1" Width="89px"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
